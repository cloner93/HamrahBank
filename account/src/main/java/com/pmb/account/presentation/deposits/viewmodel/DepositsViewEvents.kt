...
sealed interface DepositsViewEvents : BaseViewEvent {
    ...
    data class NavigateToTransactionDetails(val transactionId: String) : DepositsViewEvents
    ...
    data class AmountVisibilityChanged(val isVisible: Boolean) : DepositsViewEvents
}