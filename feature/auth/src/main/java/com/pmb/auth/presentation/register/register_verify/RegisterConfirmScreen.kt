...
fun RegisterConfirmScreen(
    ...
    AppContent(
        ...
        topBar = {
            AppTopBar(
                title = stringResource(R.string.accept_code),
                onBack = {
        ...
        ChipWithIcon(
            value = sharedState.value.mobileNo ?:"",
        ...
        AppNumberTextField(
            ...
            value = otp,
            label = stringResource(R.string.accept_code),
            ...
            onClick = {
                viewModel.handle(
                    RegisterConfirmViewActions.ConfirmVerify(
                        sharedState.value.mobileNo?:"",
                        sharedState.value.nationalCode?:"",
                        sharedState.value.serialMeli?:"",
                        otp.toInt()
                    )
                )
            })
