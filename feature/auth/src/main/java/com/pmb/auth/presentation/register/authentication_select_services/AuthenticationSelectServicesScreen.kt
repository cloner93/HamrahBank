...
import com.pmb.auth.presentation.register.authentication_select_services.viewModel.AuthenticationSelectServicesViewActions
            ...
            footer = {
                Row(
                    ...
                    AppTextButton(
                        ...
                        onClick = {
                            navigationManager.navigate(RegisterScreens.FeeDetails)
                        })
                }
