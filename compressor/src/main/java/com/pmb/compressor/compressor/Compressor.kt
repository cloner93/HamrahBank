package com.pmb.compressor.compressor
...
import com.pmb.compressor.utils.CompressorUtils.prepareVideoHeight
import com.pmb.compressor.utils.CompressorUtils.prepareVideoWidth
import com.pmb.compressor.utils.CompressorUtils.printException
import com.pmb.compressor.utils.CompressorUtils.setOutputFileParameters
import com.pmb.compressor.utils.CompressorUtils.setUpMP4Movie
import com.pmb.compressor.utils.roundDimension
import com.pmb.compressor.video.InputSurface
import com.pmb.compressor.video.MP4Builder
import com.pmb.compressor.video.OutputSurface
...
object Compressor {
    ...
    suspend fun compressVideo(
        ...
        runCatching {
            extractor.setDataSource(src, null)
        }
