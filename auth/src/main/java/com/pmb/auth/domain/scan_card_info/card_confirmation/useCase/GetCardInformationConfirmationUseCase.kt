...
class GetCardInformationConfirmationUseCase @Inject constructor(
    private val cardInformationConfirmationRepository: CardInformationConfirmationRepository
) : BaseUseCase<Unit, CardInformationConfirmationEntity>() {
    override suspend fun execute(params: Unit): Flow<Result<CardInformationConfirmationEntity>> =
        cardInformationConfirmationRepository.getCardInformationData()
}