...
class LoginRepositoryImpl @Inject constructor(
    ...
    override suspend fun login(username: String, password: String): Flow<Result<UserEntity>> =
        flow {
            ...
            if (username == accountSampleModel.userName && password == accountSampleModel.passWord) {
